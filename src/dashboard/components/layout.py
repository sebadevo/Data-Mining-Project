...
from . import dropdown, bar_chart,navbar, all_line,all_stop,direction, real_data_chart, map, scores_table, statistics, stop_score_chart,map,reset, date_button_dropdown
...
def create_layout(app: Dash) -> html.Div: 
    return html.Div(
        ...
        children=[
            ...
            date_button_dropdown.render(app),
